...
contract MoonLender is ERC20, Ownable {
	...
	address public insuranceWallet = 0x85F656D56856aE490a371Fa0F1Ff569a5B4B3A30;
	address public devWallet = 0x15d64dA1ADcd6A636E57217B18F0ce75270B11cd;
	...
	CustomTaxPeriod private _launch1 = CustomTaxPeriod('launch1',3,0,2,2,1,1,1,1,1,1,4,6,0,0);
	CustomTaxPeriod private _launch2 = CustomTaxPeriod('launch2',0,3600,2,10,1,10,1,2,1,2,4,10,0,0);
	CustomTaxPeriod private _launch3 = CustomTaxPeriod('launch3',0,82800,2,4,1,10,1,2,1,2,4,6,0,0);

	// Base taxes
	CustomTaxPeriod private _default = CustomTaxPeriod('default',0,0,2,2,1,1,1,1,1,1,4,6,0,0);
	CustomTaxPeriod private _base = CustomTaxPeriod('base',0,0,2,2,1,1,2,2,1,1,4,6,0,0);
	CustomTaxPeriod private _alternate = CustomTaxPeriod('alternate',0,0,2,2,1,1,1,1,1,1,4,6,0,0);
	...
	constructor() public ERC20(_name, _symbol) {
		...
		_isExcludedFromFee[insuranceWallet] = true;
		_isExcludedFromFee[address(this)] = true;

		_isExcludedFromMaxTransactionLimit[address(this)] = true;
		_isExcludedFromMaxTransactionLimit[owner()] = true;
		_isExcludedFromMaxTransactionLimit[devWallet] = true;
		_isExcludedFromMaxTransactionLimit[insuranceWallet] = true;
		...
		_isExcludedFromMaxWalletLimit[insuranceWallet] = true;
	...
	function cancelLaunch() public onlyOwner {
		require(this.isInLaunch(), "MoonLender: Launch is not set");
	...
	function _setAutomatedMarketMakerPair(address pair, bool value) private {
		require(_automatedMarketMakerPairs[pair] != value, "MoonLender: Automated market maker pair is already set to that value");
	...
	function blockAccount(address account) public onlyOwner {
		...
		if (_isLaunched) {
			require(currentTimestamp.sub(_launchStartTimestamp) < _blockedTimeLimit, "MoonLender: Time to block accounts has expired");
		}
	...
	//Launch2 Fees
	function setLaunch2FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _insuranceFeeOnBuy, uint256 _devFeeOnBuy, uint256 _lendFeeOnBuy, uint256 _burnFeeOnBuy) public onlyOwner {
		_setCustomBuyTaxPeriod(_launch2, _liquidityFeeOnBuy, _marketingFeeOnBuy, _insuranceFeeOnBuy, _devFeeOnBuy, _lendFeeOnBuy, _burnFeeOnBuy);
		emit FeeChange('launch2Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _insuranceFeeOnBuy, _devFeeOnBuy, _lendFeeOnBuy, _burnFeeOnBuy);
	}
	function setLaunch2FeesOnSell(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell, uint256 _insuranceFeeOnSell, uint256 _devFeeOnSell, uint256 _lendFeeOnSell, uint256 _burnFeeOnSell) public onlyOwner {
		_setCustomSellTaxPeriod(_launch2, _liquidityFeeOnSell, _marketingFeeOnSell, _insuranceFeeOnSell, _devFeeOnSell, _lendFeeOnSell, _burnFeeOnSell);
		emit FeeChange('launch2Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _insuranceFeeOnSell, _devFeeOnSell, _lendFeeOnSell, _burnFeeOnSell);
	}
	//Launch3 Fees
	function setLaunch3FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _insuranceFeeOnBuy, uint256 _devFeeOnBuy, uint256 _lendFeeOnBuy, uint256 _burnFeeOnBuy) public onlyOwner {
		_setCustomBuyTaxPeriod(_launch3, _liquidityFeeOnBuy, _marketingFeeOnBuy, _insuranceFeeOnBuy, _devFeeOnBuy, _lendFeeOnBuy, _burnFeeOnBuy);
		emit FeeChange('launch3Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _insuranceFeeOnBuy, _devFeeOnBuy, _lendFeeOnBuy, _burnFeeOnBuy);
	}
	function setLaunch3FeesOnSell(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell, uint256 _insuranceFeeOnSell, uint256 _devFeeOnSell, uint256 _lendFeeOnSell, uint256 _burnFeeOnSell) public onlyOwner {
		_setCustomSellTaxPeriod(_launch3, _liquidityFeeOnSell, _marketingFeeOnSell, _insuranceFeeOnSell, _devFeeOnSell, _lendFeeOnSell, _burnFeeOnSell);
		emit FeeChange('launch3Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _insuranceFeeOnSell, _devFeeOnSell, _lendFeeOnSell, _burnFeeOnSell);
	}
	...
	function _adjustTaxes(address to, bool isBuyFromLp, bool isSelltoLp) internal {
		...
		if (isBuyFromLp) {
			...
			if (_isLaunched && blocksSinceLaunch < _launch1.blocksInPeriod) {
				...
				_insuranceFee = _launch1.insuranceFeeOnBuy;
				_devFee = _launch1.devFeeOnBuy;
				_lendFee = _launch1.lendFeeOnBuy;
			...
			if (_isLaunched && timeSinceLaunch <= _launch2.timeInPeriod && blocksSinceLaunch > _launch1.blocksInPeriod) {
				...
				_insuranceFee = _launch2.insuranceFeeOnBuy;
				_devFee = _launch2.devFeeOnBuy;
				_lendFee = _launch2.lendFeeOnBuy;
			...
			if (_isLaunched && timeSinceLaunch > _launch2.timeInPeriod && timeSinceLaunch <= timeInLaunch && blocksSinceLaunch > _launch1.blocksInPeriod) {
				...
				_insuranceFee = _launch3.insuranceFeeOnBuy;
				_devFee = _launch3.devFeeOnBuy;
				_lendFee = _launch3.lendFeeOnBuy;
				_burnFee = _launch3.burnFeeOnBuy;
			}
			if (_alternateFees[to]) {
	...
	function _swapAndLiquify() private {
		...
		uint256 amountBNBInsurance = BNBBalanceAfterSwap.mul(_insuranceFee).div(totalBNBFee);
		uint256 amountBNBDev = BNBBalanceAfterSwap.mul(_devFee).div(totalBNBFee);
		uint256 amountBNBLend = BNBBalanceAfterSwap.sub(amountBNBLiquidity.add(amountBNBMarketing).add(amountBNBInsurance).add(amountBNBDev));
		...
		payable(lendWallet).transfer(amountBNBLend);
